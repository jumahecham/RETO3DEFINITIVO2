...
public class ControladorMensaje {
    ...
    public Mensaje save(@RequestBody Mensaje messageText) {
        return servico.save(messageText);
    }
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Mensaje update(@RequestBody Mensaje messageText) {
        return servico.update(messageText);
    }
